    ...
    return (
        ...
        <div>
            ...
            <div className="wrap-collabsible">
                <input id="collapsible4" className="toggle" tabIndex={0} type="checkbox" />
                <label htmlFor="collapsible4" className="lbl-toggle">Master's Degree</label>
            ...
            <div className="wrap-collabsible">
                ...
                <label htmlFor="collapsible5" className="lbl-toggle" tabIndex={0}>Stackable Certificates</label>
                <div className="collapsible-content">
                    <div className="content-inner">
                        <table style={{ width: "100%", tableLayout: "fixed" }} className="degree-table">
                            <thead>
            ...
            <div className="wrap-collabsible">
                ...
                <label htmlFor="collapsible6" className="lbl-toggle" tabIndex={0}>Notes</label>
                <div className="collapsible-content">
                    <div className="content-inner">
                        <table style={{ width: "100%", tableLayout: "fixed" }} className="degree-table">
                            <tbody>
